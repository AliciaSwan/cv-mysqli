...
$connexion = new mysqli('localhost', 'root', '', 'academy' );
// Check for errors
if(mysqli_connect_errno()){
    echo mysqli_connect_error();
}
$profile = $connexion->query('SELECT*FROM `profile`');
$name = $connexion->query('SELECT*FROM `name`');
...
<!--            <h3 class="tagline">--><?//=$profile[0]['post'];?><!--</h3>-->
        ...
        <div class="contact-container container-block">
            <ul class="list-unstyled contact-list">
                <?php while ($row = $profile->fetch_assoc()) { ?>
                <li class="email"><i class="fa fa-envelope"></i><a href="mailto: <?php echo $row['email'];?>"><?php echo $row['email'];?></a></li>
                <li class="phone"><i class="fa fa-phone"></i><a href="tel:<?php echo $row['phone'];?>"><?php echo $row['phone'];?></a></li>
                <li class="website"><i class="fa fa-globe"></i><a href="#" target="_blank"><?php echo $row['site'];?></a></li>
                <li class="vk"><i class="fa fa-vk"></i><a href="https://vk.com/id614451" target="_blank"><?php echo $row['social'];?></a></li>
                <?php //$profile->close();
    ...
    <div class="main-wrapper">
        ...
        <section class="section name-section">
            ...
            <h1 class="name"><?php echo $rows['name'] ?></h1>
            <hr/>
